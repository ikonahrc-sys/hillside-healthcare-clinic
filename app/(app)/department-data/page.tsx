    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm text-slate-500">
          {data.scope === "facility"
            ...
            : `${data.departmentName}'s activity at a glance.`}
        </p>
      </div>
      ...
      {data.scope === "department" && (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          <StatCard label="Referrals received" value={data.referralsReceived} />
        </div>
      )}
      ...
      {data.rehab && (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <StatCard label="New cases (last 7 days)" value={data.rehab.newCasesWeek} />
            <StatCard label="Continuing (last 7 days)" value={data.rehab.continuingWeek} />
            <StatCard label="Home health visits (last 7 days)" value={data.rehab.homeHealthVisitsWeek} />
            <StatCard label="Mobile clinic visits (last 7 days)" value={data.rehab.mobileClinicVisitsWeek} />
          </div>
        </div>
      )}
